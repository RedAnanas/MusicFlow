      ...
      <main class="watch-editor-main">
        ...
        <el-collapse v-model="openSections" class="rule-sections">
          ...
          <el-collapse-item name="rules">
            <template #title><div class="rule-title"><strong>自动处理规则</strong><small>设置扫描周期和发现文件后的行为</small></div></template>
...
<style scoped>
:global(.watch-editor-dialog) { max-width: calc(100vw - 48px); margin-top: 3vh !important; }
:global(.watch-editor-dialog .el-dialog__body) { width: auto; padding: 0; overflow: hidden; }
.watch-editor-layout { display: grid; grid-template-columns: minmax(0, 1fr) 260px; min-width: 0; min-height: 550px; overflow: hidden; }.watch-editor-main { min-width: 0; padding: 20px 24px; }.watch-editor-header { display: flex; align-items: center; gap: 13px; }.folder-symbol { display: grid; width: 44px; height: 44px; place-items: center; color: #0c9c68; background: #e5f4ef; border-radius: 11px; font-size: 20px; }.watch-editor-header > div:nth-child(2) { flex: 1; }.watch-editor-header span { color: #84908b; font-size: 10px; }.watch-editor-header h3 { margin: 3px 0 0; color: #26342e; font-size: 19px; }
.path-flow { display: grid; grid-template-columns: 1fr 28px 1fr; align-items: end; gap: 8px; padding: 14px; margin: 16px 0 11px; background: #f6f8f7; border-radius: 11px; }.path-flow > div { min-width: 0; }.path-flow span { display: block; margin-bottom: 6px; color: #89948f; font-size: 10px; }.path-flow code { display: block; overflow: hidden; color: #394942; font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }.path-flow > .el-icon { align-self: center; color: #0c9c68; }
.rule-sections { border-top: 0; }.rule-sections :deep(.el-collapse-item__header) { height: 52px; border: 1px solid #e5ebe8; border-radius: 10px; padding: 0 14px; margin-top: 8px; }.rule-sections :deep(.el-collapse-item__wrap) { border: 0; }.rule-sections :deep(.el-collapse-item__content) { padding: 12px 12px 0; }.rule-title { display: flex; align-items: center; flex: 1; min-width: 0; }.rule-title strong { color: #087955; font-size: 13px; }.rule-title small { margin-left: auto; color: #98a19d; font-size: 10px; font-weight: 400; }.rule-form { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }.rule-form :deep(.el-form-item) { margin-bottom: 8px; }.rule-form :deep(.el-select) { width: 100%; }.rule-form .el-form-item:only-child { grid-column: 1 / -1; }.option-meta { float: right; color: #9aa39f; }.path-tip { color: #8d9793; font-size: 10px; }
...
.impact-rail { padding: 20px 18px; background: #fbfcfc; border-left: 1px solid #e7ece9; }.rail-eyebrow { color: #0c9c68; font-size: 10px; font-weight: 800; letter-spacing: .1em; }.check-state { display: flex; gap: 9px; padding: 11px; margin: 11px 0 16px; color: #b87818; background: #fff7e8; border-radius: 9px; }.check-state.valid { color: #087955; background: #e8f5f0; }.check-state > div { display: flex; flex-direction: column; gap: 3px; }.check-state strong { color: #36443e; font-size: 11px; }.check-state span { font-size: 9px; }.impact-rail section { padding: 12px 0; border-top: 1px solid #e6ebe8; }.impact-rail h4 { margin: 0 0 9px; color: #53605b; font-size: 11px; }.impact-rail dl { margin: 0; }.impact-rail dl div { display: flex; justify-content: space-between; min-height: 24px; }.impact-rail dt { color: #8e9894; font-size: 10px; }.impact-rail dd { margin: 0; font-size: 10px; font-weight: 600; }.profile-tags { display: flex; flex-wrap: wrap; gap: 6px; }.profile-tags > span:not(.el-tag) { color: #969f9b; font-size: 10px; }.safety-note { display: flex; gap: 9px; color: #b67818; }.safety-note div { display: flex; flex-direction: column; gap: 5px; }.safety-note strong { color: #745018; font-size: 11px; }.safety-note span { font-size: 9px; line-height: 1.6; }.behavior-list p { display: flex; align-items: center; gap: 6px; margin: 6px 0; color: #66736e; font-size: 10px; }.behavior-list .el-icon { color: #0c9c68; }
