...
<style scoped>
:global(.profile-editor-dialog .el-dialog__body) { width: auto; padding: 0; max-height:calc(94vh - 120px); overflow-y:auto; }
...
.editor-form { max-width:980px; padding:28px 34px; margin:0 auto; }.editor-form section { width:100%; padding:20px; margin-bottom:16px; border:1px solid #eee8ff; border-radius:14px; background:#fcfbff; }.section-heading { padding-bottom:12px; margin-bottom:16px; border-bottom:1px solid #eee9f7; }.section-heading > div { display:flex; align-items:center; gap:9px; }.section-heading span { color:#8761df; font-size:11px; font-weight:800; }.section-heading h3 { margin:0; font-size:18px; }.section-heading p { margin:7px 0 0; color:#8b96aa; font-size:12px; }
